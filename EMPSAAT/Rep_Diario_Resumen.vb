...
Public Class Rep_Diario_Resumen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EMPSAAT.Rep_Diario_Resumen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRep_Diario_Resumen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rep_Diario_Resumen = New Rep_Diario_Resumen
        rpt.Site = Me.Site
        Return rpt
    End Function
