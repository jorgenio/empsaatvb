...
Public Class FacturaOtrasVentas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EMPSAAT.FacturaOtrasVentas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFacturaOtrasVentas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FacturaOtrasVentas = New FacturaOtrasVentas
        rpt.Site = Me.Site
        Return rpt
    End Function
