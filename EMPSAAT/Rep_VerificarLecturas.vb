...
Public Class Rep_VerificarLecturas
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rep_VerificarLecturas.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EMPSAAT.Rep_VerificarLecturas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRep_VerificarLecturas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rep_VerificarLecturas = New Rep_VerificarLecturas
        rpt.Site = Me.Site
        Return rpt
    End Function
