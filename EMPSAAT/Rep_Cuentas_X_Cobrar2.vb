...
Public Class Rep_Cuentas_X_Cobrar2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rep_Cuentas_X_Cobrar2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EMPSAAT.Rep_Cuentas_X_Cobrar2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRep_Cuentas_X_Cobrar2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rep_Cuentas_X_Cobrar2 = New Rep_Cuentas_X_Cobrar2
        rpt.Site = Me.Site
        Return rpt
    End Function
