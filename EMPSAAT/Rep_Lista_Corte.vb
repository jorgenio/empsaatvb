...
Public Class Rep_Lista_Corte
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EMPSAAT.Rep_Lista_Corte.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRep_Lista_Corte
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rep_Lista_Corte = New Rep_Lista_Corte
        rpt.Site = Me.Site
        Return rpt
    End Function
