...
Public Class Rep_OrdenServicio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EMPSAAT.Rep_OrdenServicio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRep_OrdenServicio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rep_OrdenServicio = New Rep_OrdenServicio
        rpt.Site = Me.Site
        Return rpt
    End Function
