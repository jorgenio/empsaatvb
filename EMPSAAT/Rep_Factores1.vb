...
Public Class Rep_Factores1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EMPSAAT.Rep_Factores1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRep_Factores1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rep_Factores1 = New Rep_Factores1
        rpt.Site = Me.Site
        Return rpt
    End Function
