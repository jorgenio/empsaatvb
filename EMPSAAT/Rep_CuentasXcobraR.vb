...
Public Class Rep_CuentasXcobraR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EMPSAAT.Rep_CuentasXcobraR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRep_CuentasXcobraR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rep_CuentasXcobraR = New Rep_CuentasXcobraR
        rpt.Site = Me.Site
        Return rpt
    End Function
